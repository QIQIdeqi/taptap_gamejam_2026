        ...
        screens = {
            {
                ...
                items = {
                    { id = "desk", name = "办公桌", x = 0.10, y = 0.54, w = 0.22, h = 0.30,
                      sprite = "assets/image/prologue_obj_desk.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.07, y = 0.61, w = 0.24, h = 0.30 },
                      clueId = "desk", dialogueId = "of_desk", interactText = "桌上散落着未结案的委托档案和空泡面杯。" },
                    { id = "lamp", name = "台灯", x = 0.23, y = 0.40, w = 0.10, h = 0.20,
                      sprite = "assets/image/prologue_obj_lamp.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.16, y = 0.49, w = 0.10, h = 0.19 },
                      dialogueId = "of_lamp_mislead", misleading = true },
                    { id = "sofa_left", name = "左侧沙发", x = 0.32, y = 0.48, w = 0.18, h = 0.24,
                      sprite = "assets/image/prologue_obj_sofa.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.31, y = 0.53, w = 0.20, h = 0.25 },
                      interactText = "沙发靠垫有些塌，看来这里经常有人坐着。" },
                    { id = "sofa_right", name = "右侧沙发", x = 0.47, y = 0.48, w = 0.14, h = 0.24,
                      sprite = "assets/image/prologue_obj_sofa.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.49, y = 0.53, w = 0.16, h = 0.25 },
                      interactText = "另一张沙发正对着茶几，旁边留出了通往餐桌的过道。" },
                    { id = "dining_table", name = "餐桌", x = 0.67, y = 0.54, w = 0.20, h = 0.28,
                      sprite = "assets/image/prologue_obj_dining_table.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.65, y = 0.57, w = 0.23, h = 0.30 },
                      interactText = "餐桌周围摆着四把椅子，桌面上还留着吃泡面的痕迹。" },
                    { id = "stove", name = "灶台", x = 0.87, y = 0.43, w = 0.13, h = 0.36,
                      sprite = "assets/image/prologue_obj_stove.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.85, y = 0.42, w = 0.15, h = 0.38 },
            ...
            },
            {
                ...
                items = {
                    { id = "bedroom_desk", name = "卧室桌子", x = 0.04, y = 0.56, w = 0.17, h = 0.28,
                      sprite = "assets/image/prologue_obj_bedroom_desk.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.07, y = 0.58, w = 0.18, h = 0.29 },
                      interactText = "卧室里的小桌子靠近入口，椅子紧挨在桌子右侧。" },
                    { id = "bedroom_chair", name = "卧室椅子", x = 0.14, y = 0.64, w = 0.10, h = 0.22,
                      sprite = "assets/image/prologue_obj_bedroom_chair.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.17, y = 0.67, w = 0.10, h = 0.21 },
                      interactText = "椅子正好放在桌子右边，旁边留着进出的空隙。" },
                    { id = "bed", name = "床铺", x = 0.19, y = 0.53, w = 0.30, h = 0.30,
                      sprite = "assets/image/prologue_obj_bed.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.25, y = 0.57, w = 0.30, h = 0.28 },
                      clueId = "bed", dialogueId = "of_bed", interactText = "这段时间都由陈雯音睡在这张床上。" },
                    { id = "wardrobe", name = "衣柜", x = 0.62, y = 0.25, w = 0.28, h = 0.45,
                      sprite = "assets/image/prologue_obj_wardrobe.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.69, y = 0.28, w = 0.20, h = 0.44 },
