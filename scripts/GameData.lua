        ...
        screens = {
            {
                ...
                left = nil, right = "s2",
                items = {
                    { id = "desk", name = "办公桌", x = 0.21, y = 0.52, w = 0.28, h = 0.40, hoverScale = 1.08,
                      sprite = "assets/image/prologue_obj_desk.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.24, y = 0.54, w = 0.24, h = 0.35 },
                      clueId = "desk", dialogueId = "of_desk", interactText = "桌上散落着未结案的委托档案和空泡面杯。" },
                    { id = "lamp", name = "台灯", x = 0.36, y = 0.36, w = 0.12, h = 0.27, hoverScale = 1.10,
                      sprite = "assets/image/prologue_obj_lamp.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.39, y = 0.39, w = 0.08, h = 0.23 },
                      dialogueId = "of_lamp_mislead", misleading = true },
                    { id = "sofa_left", name = "左侧沙发", x = 0.42, y = 0.54, w = 0.17, h = 0.27, hoverScale = 1.08,
                      sprite = "assets/image/prologue_obj_sofa.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.43, y = 0.56, w = 0.15, h = 0.24 },
                      interactText = "沙发靠垫有些塌，看来这里经常有人坐着。" },
                    { id = "sofa_right", name = "右侧沙发", x = 0.57, y = 0.54, w = 0.17, h = 0.27, hoverScale = 1.08,
                      sprite = "assets/image/prologue_obj_sofa.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.58, y = 0.56, w = 0.15, h = 0.24 },
                      interactText = "另一张沙发正对着茶几，旁边留出了通往餐桌的过道。" },
                    { id = "dining_table", name = "餐桌", x = 0.70, y = 0.57, w = 0.17, h = 0.28, hoverScale = 1.07,
                      sprite = "assets/image/prologue_obj_dining_table.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.71, y = 0.60, w = 0.15, h = 0.25 },
                      interactText = "餐桌周围摆着四把椅子，桌面上还留着吃泡面的痕迹。" },
                    { id = "stove", name = "灶台", x = 0.83, y = 0.40, w = 0.15, h = 0.40, hoverScale = 1.06,
                      sprite = "assets/image/prologue_obj_stove.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.84, y = 0.41, w = 0.14, h = 0.36 },
            ...
            },
            {
                ...
                left = "s1", right = nil,
                items = {
                    { id = "bedroom_desk", name = "卧室桌子", x = 0.19, y = 0.53, w = 0.22, h = 0.37, hoverScale = 1.08,
                      sprite = "assets/image/prologue_obj_bedroom_desk.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.21, y = 0.54, w = 0.19, h = 0.33 },
                      interactText = "卧室里的小桌子靠近入口，椅子紧挨在桌子右侧。" },
                    { id = "bedroom_chair", name = "卧室椅子", x = 0.37, y = 0.63, w = 0.10, h = 0.26, hoverScale = 1.08,
                      sprite = "assets/image/prologue_obj_bedroom_chair.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.39, y = 0.64, w = 0.08, h = 0.24 },
                      interactText = "椅子正好放在桌子右边，旁边留着进出的空隙。" },
                    { id = "bed", name = "床铺", x = 0.47, y = 0.54, w = 0.31, h = 0.33, hoverScale = 1.07,
                      sprite = "assets/image/prologue_obj_bed.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.46, y = 0.56, w = 0.32, h = 0.29 },
                      clueId = "bed", dialogueId = "of_bed", interactText = "这段时间都由陈雯音睡在这张床上。" },
                    { id = "wardrobe", name = "衣柜", x = 0.67, y = 0.25, w = 0.23, h = 0.50, hoverScale = 1.06,
                      sprite = "assets/image/prologue_obj_wardrobe.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.68, y = 0.26, w = 0.22, h = 0.47 },
