        ...
        screens = {
            {
                ...
                -- 背景原图为 1940×823；以原图坐标映射到视口，避免横屏/高 DPI 拉伸漂移。
                designW = 1940, designH = 823,
                backgroundFit = "cover", backgroundPosition = "center center",
                bgColor = { 150, 120, 70, 255 },
                charPos = { x = 0.22, y = 0.78, scale = 0.60 },
                left = nil, right = "s2",
                items = {
                    -- Figma 图层自下而上：台灯、灶台、沙发、餐桌、办公桌。
                    { id = "lamp", name = "台灯", x = 0.406186, y = 0.390036, w = 0.047423, h = 0.229648, hoverScale = 1.10,
                      sprite = "assets/image/prologue_obj_lamp.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.406186, y = 0.390036, w = 0.047423, h = 0.229648 },
                      dialogueId = "of_lamp_mislead", misleading = true },
                    { id = "stove", name = "灶台", x = 0.697423, y = 0.466586, w = 0.285567, h = 0.437424, hoverScale = 1.06,
                      sprite = "assets/image/prologue_obj_stove.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.697423, y = 0.466586, w = 0.285567, h = 0.437424 },
                      interactText = "靠墙的灶台和操作台很简陋，但足够煮一锅泡面。" },
                    { id = "sofa_left", name = "左侧沙发", x = 0.354639, y = 0.523694, w = 0.150000, h = 0.213852, hoverScale = 1.08,
                      sprite = "assets/image/prologue_obj_sofa.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.354639, y = 0.523694, w = 0.150000, h = 0.213852 },
                      interactText = "沙发靠垫有些塌，看来这里经常有人坐着。" },
                    { id = "sofa_right", name = "右侧沙发", x = 0.519072, y = 0.523694, w = 0.150000, h = 0.213852, hoverScale = 1.08,
                      sprite = "assets/image/prologue_obj_sofa.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.519072, y = 0.523694, w = 0.150000, h = 0.213852 },
                      interactText = "另一张沙发正对着茶几，旁边留出了通往餐桌的过道。" },
                    { id = "dining_table", name = "餐桌", x = 0.535567, y = 0.605103, w = 0.302062, h = 0.314702, hoverScale = 1.07,
                      sprite = "assets/image/prologue_obj_dining_table.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.535567, y = 0.605103, w = 0.302062, h = 0.314702 },
                      interactText = "餐桌周围摆着四把椅子，桌面上还留着吃泡面的痕迹。" },
                    { id = "desk", name = "办公桌", x = 0.171134, y = 0.539490, w = 0.232474, h = 0.396112, hoverScale = 1.08,
                      sprite = "assets/image/prologue_obj_desk.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.171134, y = 0.539490, w = 0.232474, h = 0.396112 },
            ...
            },
            {
                ...
                left = "s1", right = nil,
                items = {
                    { id = "bedroom_desk", name = "卧室桌子", x = 0.209794, y = 0.565006, w = 0.189691, h = 0.304982, hoverScale = 1.08,
                      sprite = "assets/image/prologue_obj_bedroom_desk.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.209794, y = 0.565006, w = 0.189691, h = 0.304982 },
                      interactText = "卧室里的小桌子靠近入口，椅子紧挨在桌子右侧。" },
                    { id = "bedroom_chair", name = "卧室椅子", x = 0.402577, y = 0.640340, w = 0.055670, h = 0.240583, hoverScale = 1.08,
                      sprite = "assets/image/prologue_obj_bedroom_chair.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.402577, y = 0.640340, w = 0.055670, h = 0.240583 },
                      interactText = "椅子正好放在桌子右边，旁边留着进出的空隙。" },
                    { id = "bed", name = "床铺", x = 0.459794, y = 0.588092, w = 0.320103, h = 0.261239, hoverScale = 1.07,
                      sprite = "assets/image/prologue_obj_bed.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.459794, y = 0.588092, w = 0.320103, h = 0.261239 },
                      clueId = "bed", dialogueId = "of_bed", interactText = "这段时间都由陈雯音睡在这张床上。" },
                    { id = "wardrobe", name = "衣柜", x = 0.679897, y = 0.357230, w = 0.220103, h = 0.373026, hoverScale = 1.06,
                      sprite = "assets/image/prologue_obj_wardrobe.png", interactiveSprite = true, spriteTrim = true, spriteRect = { x = 0.679897, y = 0.357230, w = 0.220103, h = 0.373026 },
