...
M.SceneObjects = {
    ...
    office = {
        ...
        spawnX = 520,
        layers = {
            background = { image = "assets/image/bg_office_bg.png",     parallax = 0.35 },
            midground  = { image = "assets/image/bg_office_mid.png",    parallax = 1.0  },
            foreground = { image = "assets/image/bg_office_fg.png",     parallax = 1.4  },
        },
        exits = {},
        items = {
            {
            ...
            },
            {
                id = "wardrobe",
                name = "衣柜",
                x = 1640, y = 0.20, w = 360, h = 0.58,
                clueId = "wardrobe",
                interactText = "衣柜里堆满了深色的衣服，衣服堆下面似乎埋着李志的袜子。",
                onInteract = "wardrobe",  -- 特殊交互：触发剧情推进
            },
            {
                id = "bed",
                name = "床铺",
                x = 1300, y = 0.62, w = 760, h = 0.28,
                clueId = "bed",
